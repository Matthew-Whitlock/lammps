...
void PairLJCutCoulDSF::write_restart(Store fp)
{
...
void PairLJCutCoulDSF::read_restart(Store fp)
{
...
void PairLJCutCoulDSF::write_restart_settings(Store fp)
{
...
void PairLJCutCoulDSF::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
