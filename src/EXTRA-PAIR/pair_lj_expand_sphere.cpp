...
void PairLJExpandSphere::write_restart(Store fp)
{
...
void PairLJExpandSphere::read_restart(Store fp)
{
...
void PairLJExpandSphere::write_restart_settings(Store fp)
{
...
void PairLJExpandSphere::read_restart_settings(Store fp)
{
  int me = comm->me;
  if (me == 0) {
