...
void PairCoulExclude::write_restart(Store fp)
{
...
void PairCoulExclude::read_restart(Store fp)
{
...
void PairCoulExclude::write_restart_settings(Store fp)
{
...
void PairCoulExclude::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
