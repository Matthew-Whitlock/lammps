...
void PairCoulDiel::write_restart(Store fp)
{
...
void PairCoulDiel::read_restart(Store fp)
{
...
void PairCoulDiel::write_restart_settings(Store fp)
{
...
void PairCoulDiel::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
