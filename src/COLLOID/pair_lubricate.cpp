...
void PairLubricate::write_restart(Store fp)
{
...
void PairLubricate::read_restart(Store fp)
{
...
void PairLubricate::write_restart_settings(Store fp)
{
...
void PairLubricate::read_restart_settings(Store fp)
{
  int me = comm->me;
  if (me == 0) {
