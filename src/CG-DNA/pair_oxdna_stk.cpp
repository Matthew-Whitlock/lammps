...
void PairOxdnaStk::write_restart(Store fp)
{
...
void PairOxdnaStk::read_restart(Store fp)
{
...
void PairOxdnaStk::write_restart_settings(Store fp)
{
...
void PairOxdnaStk::read_restart_settings(Store fp)
{
  int me = comm->me;
  if (me == 0) {
