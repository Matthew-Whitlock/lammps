...
void PairOxdna2Coaxstk::write_restart(Store fp)
{
...
void PairOxdna2Coaxstk::read_restart(Store fp)
{
...
void PairOxdna2Coaxstk::write_restart_settings(Store fp)
{
...
void PairOxdna2Coaxstk::read_restart_settings(Store fp)
{
  int me = comm->me;
  if (me == 0) {
