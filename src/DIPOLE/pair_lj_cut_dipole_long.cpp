...
void PairLJCutDipoleLong::write_restart(Store fp)
{
...
void PairLJCutDipoleLong::read_restart(Store fp)
{
...
void PairLJCutDipoleLong::write_restart_settings(Store fp)
{
...
void PairLJCutDipoleLong::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
