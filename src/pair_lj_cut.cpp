...
void PairLJCut::write_restart(Store fp)
{
...
void PairLJCut::read_restart(Store fp)
{
...
void PairLJCut::write_restart_settings(Store fp)
{
...
void PairLJCut::read_restart_settings(Store fp)
{
  int me = comm->me;
  if (me == 0) {
