...
void PairEDPD::write_restart(Store fp)
{
...
void PairEDPD::read_restart(Store fp)
{
...
void PairEDPD::write_restart_settings(Store fp)
{
...
void PairEDPD::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
