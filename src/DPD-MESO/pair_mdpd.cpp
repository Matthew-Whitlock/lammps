...
void PairMDPD::write_restart(Store fp)
{
...
void PairMDPD::read_restart(Store fp)
{
...
void PairMDPD::write_restart_settings(Store fp)
{
...
void PairMDPD::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
