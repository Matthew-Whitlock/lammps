...
void PairTDPD::write_restart(Store fp)
{
...
void PairTDPD::read_restart(Store fp)
{
...
void PairTDPD::write_restart_settings(Store fp)
{
...
void PairTDPD::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
