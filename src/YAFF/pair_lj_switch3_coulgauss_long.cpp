...
void PairLJSwitch3CoulGaussLong::write_restart(Store fp)
{
...
void PairLJSwitch3CoulGaussLong::read_restart(Store fp)
{
...
void PairLJSwitch3CoulGaussLong::write_restart_settings(Store fp)
{
...
void PairLJSwitch3CoulGaussLong::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
