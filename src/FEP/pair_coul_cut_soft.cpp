...
void PairCoulCutSoft::write_restart(Store fp)
{
...
void PairCoulCutSoft::read_restart(Store fp)
{
...
void PairCoulCutSoft::write_restart_settings(Store fp)
{
...
void PairCoulCutSoft::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
