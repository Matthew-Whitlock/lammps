...
void PairLJCutCoulCutSoft::write_restart(Store fp)
{
...
void PairLJCutCoulCutSoft::read_restart(Store fp)
{
...
void PairLJCutCoulCutSoft::write_restart_settings(Store fp)
{
...
void PairLJCutCoulCutSoft::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
