...
void PairLJCutCoulLongSoft::write_restart(Store fp)
{
...
void PairLJCutCoulLongSoft::read_restart(Store fp)
{
...
void PairLJCutCoulLongSoft::write_restart_settings(Store fp)
{
...
void PairLJCutCoulLongSoft::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
