...
void PairLJCharmmCoulLongSoft::write_restart(Store fp)
{
...
void PairLJCharmmCoulLongSoft::read_restart(Store fp)
{
...
void PairLJCharmmCoulLongSoft::write_restart_settings(Store fp)
{
...
void PairLJCharmmCoulLongSoft::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
