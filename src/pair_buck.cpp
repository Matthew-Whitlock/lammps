...
void PairBuck::write_restart(Store fp)
{
...
void PairBuck::read_restart(Store fp)
{
...
void PairBuck::write_restart_settings(Store fp)
{
...
void PairBuck::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
