...
#ifndef LMP_STORE_BUFFER_H
#define LMP_STORE_BUFFER_H
...
class StoreBuffer : public StoreImpl, protected Pointers {
 public:
  StoreBuffer(LAMMPS*, std::vector<char>&);
  StoreBuffer(LAMMPS*, char*, bigint);
