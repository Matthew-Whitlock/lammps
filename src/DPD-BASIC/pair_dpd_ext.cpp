...
void PairDPDExt::write_restart(Store fp)
{
...
void PairDPDExt::read_restart(Store fp)
{
...
void PairDPDExt::write_restart_settings(Store fp)
{
...
void PairDPDExt::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
