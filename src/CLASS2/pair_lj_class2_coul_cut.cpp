...
void PairLJClass2CoulCut::write_restart(Store fp)
{
...
void PairLJClass2CoulCut::read_restart(Store fp)
{
...
void PairLJClass2CoulCut::write_restart_settings(Store fp)
{
...
void PairLJClass2CoulCut::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
