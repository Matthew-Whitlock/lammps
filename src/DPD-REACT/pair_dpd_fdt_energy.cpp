...
void PairDPDfdtEnergy::write_restart(Store fp)
{
...
void PairDPDfdtEnergy::read_restart(Store fp)
{
...
void PairDPDfdtEnergy::write_restart_settings(Store fp)
{
...
void PairDPDfdtEnergy::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
