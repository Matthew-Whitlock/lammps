...
void PairDPDfdt::write_restart(Store fp)
{
...
void PairDPDfdt::read_restart(Store fp)
{
...
void PairDPDfdt::write_restart_settings(Store fp)
{
...
void PairDPDfdt::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
