...
void PairCoulDSF::write_restart(Store fp)
{
...
void PairCoulDSF::read_restart(Store fp)
{
...
void PairCoulDSF::write_restart_settings(Store fp)
{
...
void PairCoulDSF::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
