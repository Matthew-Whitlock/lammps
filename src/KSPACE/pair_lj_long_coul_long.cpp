...
void PairLJLongCoulLong::write_restart(Store fp)
{
...
void PairLJLongCoulLong::read_restart(Store fp)
{
...
void PairLJLongCoulLong::write_restart_settings(Store fp)
{
...
void PairLJLongCoulLong::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
