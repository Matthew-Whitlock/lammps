...
void PairBuckLongCoulLong::write_restart(Store fp)
{
...
void PairBuckLongCoulLong::read_restart(Store fp)
{
...
void PairBuckLongCoulLong::write_restart_settings(Store fp)
{
...
void PairBuckLongCoulLong::read_restart_settings(Store fp)
{
  if (comm->me == 0) {
